...
const char *ssid = "NetComm 1695";
const char *password = "Ligeculera";
...
{
  const int nSteps = 20 * 64;   // Will do one revolution (20*64 microsteps)
  static int microsteps = 0; // Number of microsteps passed
  const int pre_steps = 25;  // Number of steps the motor takes before scanning for the leadscrew to gain grip.
...
void setup()
{
  ...
  //Serial.println("Initalise Complete");
}
